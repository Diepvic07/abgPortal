...
export function AdminMemberModal({ member, onClose }: AdminMemberModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center sm:p-6 pb-0">
      ...
      <div
        className="relative w-full sm:max-w-3xl bg-white rounded-t-3xl sm:rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[95vh] sm:max-h-[90vh] animate-slide-in"
      ...
      >
        <div className="h-32 sm:h-36 bg-gradient-to-br from-brand to-brand-light relative flex-shrink-0">
          ...
          <button
            onClick={onClose}
            className="absolute right-4 top-4 w-8 h-8 rounded-full bg-white/20 hover:bg-white/30 text-white flex items-center justify-center transition-colors z-10"
        ...
        <div className="flex-1 overflow-y-auto pb-10 scrollbar-hide sm:scrollbar-default">
