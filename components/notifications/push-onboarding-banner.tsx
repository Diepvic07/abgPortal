...
export function PushOnboardingBanner() {
  ...
  useEffect(() => {
    ...
    setVisible(true);
  }, [session, isSubscribed, permission, pushLoading]);
  ...
  const handleEnable = useCallback(async () => {
    ...
    // On mobile (not already installed as PWA), show install guide
    if (isMobile && !isPwa) {
  ...
  }, [subscribe, toggles, isMobile, isPwa]);
    ...
    >
      <div className="mx-auto max-w-2xl px-4 pb-4">
        <div className="rounded-2xl bg-white shadow-2xl border border-gray-200 overflow-hidden">
            ...
            <div className="p-5 flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-base font-semibold text-gray-900">
                  {t.pushOnboarding.bannerTitle}
                </h3>
                <p className="text-sm text-gray-500 mt-0.5">
                  {t.pushOnboarding.bannerDescription}
                </p>
          ...
          {/* Step: Install Guide (mobile only) */}
          {step === 'install-guide' && (
            <div className="p-5">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-sm font-medium text-green-700">{t.pushOnboarding.successMessage}</p>
                </div>
                <button
                  onClick={dismiss}
                  className="text-gray-400 hover:text-gray-600 transition-colors"
          ...
          {step === 'done' && (
            <div className="p-5 flex items-center gap-3">
              ...
              <p className="text-base font-semibold text-gray-900">
                {isPwa ? t.pushOnboarding.alreadyInstalled : t.pushOnboarding.successMessage}
              </p>
            </div>
          )}
        </div>
