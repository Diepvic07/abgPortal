...
import { PublicReferencesManager } from '@/components/profile/public-references-manager';
...
export function ProfileViewDisplay({ member, membershipStatus }: ProfileViewDisplayProps) {
  ...
  return (
    ...
    <div className="max-w-4xl mx-auto space-y-5">
      ...
      <PublicReferencesManager member={member} membershipStatus={membershipStatus} />
    </div>
