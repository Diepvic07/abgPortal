...
export const vi: Translations = {
  ...
  homepage: {
    ...
    whyJoin: {
      ...
      connectDesc: "Truy cập danh bạ ABG Alumni, yêu cầu giới thiệu và xây dựng mối quan hệ trong cộng đồng uy tín, đa dạng.",
      discover: "Khám Phá Cơ Hội",
      discoverDesc: "Thông qua \"Kiếm kèo kết nối\" để tìm lại bạn cũ, kết nối với người mới, tìm kiếm đối tác công việc, cơ hội phát triển độc bản.",
      stayEngaged: "Luôn Gắn Kết & Học Hỏi",
      stayEngagedDesc: "Duy trì sự kết nối sau khóa học với kho tàng kinh nghiệm liên thế hệ, các hoạt động sự kiện năng động của mạng lưới.",
    },
    whatYouCanDo: {
      ...
      introDesc: "Nền tảng giúp bạn kết nối trực tiếp với ABGers khác.",
      ...
      description1: "Sử dụng nền tảng để khám phá danh bạ, tìm thành viên theo ngành nghề và vị trí, và yêu cầu kết nối có ý nghĩa trong mạng lưới ABG.",
      description2: "Cập nhật hoạt động và mở khóa quyền truy cập đầy đủ với gói Premium.",
    },
    howItWorks: {
      title: "Cách Thức Hoạt Động",
      ...
      step2Desc: "Xác nhận hồ sơ ABGer hoặc yêu cầu xét duyệt.",
    ...
    stats: {
      ...
      alumni: "Hồ Sơ Alumni",
      countries: "Quốc Gia/Vị trí địa lý",
  ...
  email: {
    ...
    profilePrompt: {
      ...
      greeting: 'Xin chào {name},',
      intro: 'Chào mừng bạn đến với Premium! Để nhận gợi ý kết nối AI phù hợp, hãy hoàn thiện một số thông tin quan trọng trên hồ sơ:',
