...
export const en = {
  ...
  pushOnboarding: {
    ...
    installGuideStep4iOS: 'Close Safari, open "ABG Connect" from your Home Screen and enable push notifications',
    ...
    installGuideStep4Android: 'Open "ABG Connect" from your Home Screen and enable push notifications',
