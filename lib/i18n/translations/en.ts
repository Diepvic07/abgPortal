...
export const en = {
  ...
  homepage: {
    ...
    whatYouCanDo: {
      ...
      introLabel: "Intros",
      updatesLabel: "Stay Informed",
      premiumLabel: "Upgrade",
      description1: "Use the portal to explore the alumni directory, discover members across industries and locations, and request meaningful connections inside the ABG network.",
      description2: "Stay updated on alumni activities and unlock full member access for deeper discovery and premium features.",
    },
    howItWorks: {
      title: "How It Works",
  ...
  email: {
    ...
    profilePrompt: {
      ...
      greeting: 'Hi {name},',
      intro: 'Welcome to Premium! To unlock personalized AI matches, please complete a few key fields on your profile:',
